...
- 📐✅ [jcode/proteusRevival] #proteus #messaging #spec OUTCOME: Authored specs/proteus_messaging.md (spec-lock draft accepted): Vert.x 5.1.8 embedded event bus + @ConsumeEvent in proteus-core, NATS bridge (jnats 2.23.0, JSON envelope, queue groups, subject mapping), proteus-websocket module revival (Undertow-native annotations + broadcast service), full HOCON config contract, verification gates incl. local NATS server nats://127.0.0.1:4232. Supersedes the finalization spec's messaging exclusion.
