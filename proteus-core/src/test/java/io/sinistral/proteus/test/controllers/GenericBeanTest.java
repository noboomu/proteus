...
class GenericBeanTest {
    ...
    public static class GenericClass {
        ...
        public io.sinistral.proteus.test.controllers.GenericBean<Long> bean =
            new io.sinistral.proteus.test.controllers.GenericBean<>();
        ...
        public List<GenericBean<Long>> getGenericClassBean(
        ...
        public List<Map<String, Set<Long>>> getComplex() {
            ...
            return List.of(
                Map.of(
                    "a",
                    random.longs(5).boxed().collect(Collectors.toSet())
                ),
                Map.of(
                    "b",
                    random.longs(15).boxed().collect(Collectors.toSet())
                )
            );
        }
    ...
    public static <T> Class<T> resolveGenericType(Class<?> declaredClass) {
        if (declaredClass.isAssignableFrom(ParameterizedType.class)) {
            ParameterizedType parameterizedType =
                (ParameterizedType) declaredClass.getGenericSuperclass();
    ...
    private JavaType constructJavaType(final Type type) {
        // Jackson 3.0 simplified API - constructType now handles type bindings automatically
    ...
    void genericTypeHandler() throws Exception {
        Set<Method> methods = ReflectionUtils.get(
            ReflectionUtils.Methods.get(GenericClass.class)
        );
        ...
        for (Method m : methods) {
            ...
            if (m.getName().contains("get")) {
                ...
                if (type instanceof ParameterizedType) {
                    s = ClassUtilities.typeReferenceNameForParameterizedType(
                ...
                logger.info(
                    ...
                    generateTypeReference(m.getReturnType())
                );

                Map<TypeVariable<?>, Type> typeArgs = new HashMap<>();

                if (type instanceof ParameterizedType) {
                    typeArgs = TypeUtils.getTypeArguments(
                        (ParameterizedType) type
                    );
                }
                ...
                methodSpecBuilder.addTypeVariables(
                    typeArgs
                        .keySet()
                        .stream()
                ...
                logger.info(
                    "args: {}\nmethod: {}",
                    typeArgs,
                    methodSpecBuilder.build().toString()
                );
                ...
                sb1
                    ...
                    .append(type)
                    .append(" => ")
                    .append(genericReturnType.getTypeName())
                    .append("\n");
                typeArgs.forEach((k, v) -> {
                    sb1
                        ...
                        .append(k.getName())
                        .append(" typeName: ")
                        .append(k.getTypeName())
                        .append(" bounds: ")
                        .append(Arrays.toString(k.getBounds()))
                        .append("\n");
                    sb1
                        .append("value: ")
                        .append(v)
                ...
                List<TypeVariable<?>> genericParameterTypes = Arrays.stream(
                    genericReturnType.getTypeParameters()
                ).collect(Collectors.toList());

                StringBuilder sb = new StringBuilder()
                    .append("\n")
                    .append("generic return type: ")
                    .append(genericReturnType)
                    .append("\t")
                    .append(genericReturnType.getTypeName())
                    .append("\n")
                    .append("getGenericReturnType:\t")
                    .append(m.getGenericReturnType())
                    .append("\n")
                    .append("type parameters: ")
                    .append(genericParameterTypes);
