...
public class Tests {
        ...
        try {
            response(
                objectMapper.writeValueAsString(
                    ImmutableMap.of("message", "Hello, World!")
                )
            )
                .applicationJson()
                .send(exchange);
    ...
    public CompletableFuture<Map<String, String>> responseFutureMap(
    ...
    @GET
    @Path("response/map")
    public ServerResponse<Map<String, String>> futureMap(
        ServerRequest request
    ) {
        Map<String, String> map = ImmutableMap.of("message", "success");
    ...
    public ServerResponse<ByteBuffer> responseUploadFilePath(
        ServerRequest request,
        ...
        return response(
            ByteBuffer.wrap(Files.toByteArray(file.toFile()))
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    public ServerResponse<ByteBuffer> responseUploadOptionalFilePath(
        ServerRequest request,
        @FormParam("file") Optional<java.nio.file.Path> file
    ) throws Exception {
        if (file.isPresent()) {
            return response(
                ByteBuffer.wrap(Files.toByteArray(file.get().toFile()))
            ).applicationOctetStream();
        } else {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    public ServerResponse<User> responseEchoJson(
        ServerRequest request,
    ...
    public ServerResponse<User> responseInnerClassTest(
        ServerRequest request,
        @BeanParam User user
    ) throws Exception {
        return response(user).applicationJson();
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<User> responseInnerClassOptionalTest(
        ServerRequest request,
        @BeanParam Optional<User> user
    ) throws Exception {
    ...
    @Path("generic/set")
    @Produces((MediaType.APPLICATION_JSON))
    public ServerResponse<Set<Long>> genericSet(
        ServerRequest request,
    ...
    @Produces((MediaType.APPLICATION_JSON))
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<Set<Long>> genericBeanSet(
        ServerRequest request,
        @BeanParam Set<Long> ids
    ) throws Exception {
        return response(ids).applicationJson();
    }
    ...
    @Produces((MediaType.APPLICATION_JSON))
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<Map<String, Long>> genericBeanMap(
        ServerRequest request,
        @BeanParam Map<String, Long> ids
    ) throws Exception {
        return response(ids).applicationJson();
    }
    ...
    @Produces((MediaType.APPLICATION_JSON))
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<GenericBean<Long>> genericBeanList(
        ServerRequest request,
        @BeanParam GenericBean<Long> genericBean
    ) throws Exception {
    ...
    @Produces((MediaType.APPLICATION_JSON))
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<List<Long>> genericBeanList(
        ServerRequest request,
        @BeanParam List<Long> ids
    ) throws Exception {
        return response(ids).applicationJson();
    }
    ...
    @Path("optional/set")
    @Produces((MediaType.APPLICATION_JSON))
    public ServerResponse<Set<Long>> genericOptionalSet(
        ServerRequest request,
        @QueryParam("ids") Optional<Set<Long>> ids
    ) throws Exception {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public ServerResponse<List<Long>> listConversion(
        ServerRequest request,
        @BeanParam List<Long> ids
    ) throws Exception {
        return response(ids).applicationJson();
    ...
    @Blocking
    @Produces(MediaType.TEXT_PLAIN)
    public ServerResponse<ByteBuffer> timestampConversion(
        ServerRequest request,
    ...
    @Blocking
    @Produces(MediaType.TEXT_PLAIN)
    public ServerResponse<ByteBuffer> doubleConversion(
        ServerRequest request,
    ...
    @Blocking
    @Produces(MediaType.TEXT_PLAIN)
    public ServerResponse<ByteBuffer> bigDecimalConversion(
        ServerRequest request,
    ...
    @Blocking
    @Produces(MediaType.TEXT_PLAIN)
    public ServerResponse<ByteBuffer> instantConversion(
        ServerRequest request,
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Consumes("*/*")
    public ServerResponse<ByteBuffer> responseUploadByteBuffer(
        ServerRequest request,
        @FormParam("file") ByteBuffer file
    ) throws Exception {
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Consumes("*/*")
    public ServerResponse<ByteBuffer> responseUploadFile(
        ServerRequest request,
    ...
    @Consumes("*/*")
    @Blocking
    public ServerResponse<Map<String, String>> uploadMultipleFileList(
        ServerRequest request,
    ...
    @Consumes("*/*")
    @Blocking
    public ServerResponse<Map<String, String>> uploadMultiplePathList(
        ServerRequest request,
        @FormParam("files") List<java.nio.file.Path> files,
        @FormParam("names") List<String> names
    ) throws Exception {
        Map<String, String> map = new HashMap<>();
    ...
    @Consumes("*/*")
    @Blocking
    public ServerResponse<Map<String, String>> uploadMultipleFileMap(
        ServerRequest request,
        @FormParam("files") Map<String, File> files
    ) throws Exception {
        Map<String, String> map = new HashMap<>();
    ...
    @Consumes("*/*")
    @Blocking
    public ServerResponse<Map<String, String>> uploadMultiplePathMap(
        ServerRequest request,
        @FormParam("files") Map<String, java.nio.file.Path> files
    ) throws Exception {
        Map<String, String> map = new HashMap<>();
    ...
    @Produces(MediaType.TEXT_PLAIN)
    public ServerResponse<ByteBuffer> pathParamEndpoint(
        ServerRequest request,
    ...
    public ServerResponse<Map<String, String>> debugEndpoint(
        ServerRequest request
    ) {
        try {
            String testString = request
                .getExchange()
                .getAttachment(DEBUG_TEST_KEY);
    ...
    public ServerResponse<Void> notFoundError(
        ServerRequest request,
        @QueryParam("test") Optional<String> param
    ) throws Exception {
        if (!param.isPresent()) {
    ...
    @GET
    @Path("response/max")
    public ServerResponse<ByteBuffer> maxValue(
        ServerRequest request,
        @QueryParam("param") @Max(100) Integer param
    ) throws Exception {
    ...
    @GET
    @Path("response/min")
    public ServerResponse<ByteBuffer> minValue(
        ServerRequest request,
        @QueryParam("param") @Min(10) Integer param
    ) throws Exception {
        return response().body(param.toString());
    }
    @GET
    ...
    > responseFutureResponseMap(ServerRequest request) {
        Map<String, String> map = ImmutableMap.of("message", "success");
        return CompletableFuture.completedFuture(
            response(map).applicationJson().ok()
        );
    }

    @GET
    @Path("response/error/401")
    public ServerResponse<Void> unauthorizedError(
        ServerRequest request,
        @QueryParam("test") Optional<String> param
    ) throws Exception {
        if (!param.isPresent()) {
    ...
    @Blocking
    public ServerResponse<Map<String, String>> debugBlockingEndpoint(
        ServerRequest request
    ) {
        try {
            Map<String, String> map = ImmutableMap.of(
    ...
    @Blocking
    public ServerResponse<Map<String, String>> badRequestBlocking(
        ServerRequest request
    ) {
        return response().badRequest(
            new ServerException("Bad Request", StatusCodes.BAD_REQUEST)
        );
    }

    @GET
    @Path("response/badrequest")
    public ServerResponse<Map<String, String>> badRequest(
        ServerRequest request
    ) {
        return response().badRequest(
            new ServerException("Bad Request", StatusCodes.BAD_REQUEST)
    ...
    public CompletableFuture<
        ServerResponse<Map<String, String>>
    > responseFutureBadRequest(ServerRequest request) {
        CompletableFuture<ServerResponse<Map<String, String>>> future =
    ...
    public CompletableFuture<
        ServerResponse<Map<String, String>>
    > responseFutureBadRequestBlocking(ServerRequest request) {
        CompletableFuture<ServerResponse<Map<String, String>>> future =
            new CompletableFuture<>();
    ...
    public CompletableFuture<
        ServerResponse<Map<String, String>>
    > responseFutureNotFoundBlocking(ServerRequest request) {
        CompletableFuture<ServerResponse<Map<String, String>>> future =
            new CompletableFuture<>();
    ...
    public CompletableFuture<
        ServerResponse<Map<String, String>>
    > responseFutureUser(ServerRequest request) {
        CompletableFuture<ServerResponse<Map<String, String>>> future =
            new CompletableFuture<>();
        ...
        request
            ...
            .execute(() -> {
                try {
                    ...
                    future.complete(
                        response(Map.of("status", "OK")).applicationJson().ok()
                    );
                } catch (Exception e) {
                    future.completeExceptionally(e);
                }
    ...
    public CompletableFuture<
        ServerResponse<Map<String, String>>
    > responseFutureUserBlocking(ServerRequest request) {
        CompletableFuture<ServerResponse<Map<String, String>>> future =
            new CompletableFuture<>();
    ...
    public ServerResponse<Map<String, Object>> complexParameters(
        ...
        @QueryParam("optionalQueryEnum") Optional<
            User.UserType
        > optionalQueryEnum,
        @HeaderParam("optionalHeaderString") Optional<
            String
        ...
        responseMap.put(
            "optionalQueryString",
            optionalQueryString.orElse(null)
        );
        responseMap.put("optionalQueryLong", optionalQueryLong.orElse(null));
        responseMap.put(
            "optionalQueryDate",
            optionalQueryDate.map(OffsetDateTime::toString).orElse(null)
        );
        responseMap.put(
            "optionalQueryUUID",
            optionalQueryUUID.map(UUID::toString).orElse(null)
        );
        responseMap.put(
            "optionalHeaderUUID",
            optionalHeaderUUID.map(UUID::toString).orElse(null)
        );
        responseMap.put(
            "optionalHeaderString",
            optionalHeaderString.orElse(null)
        );
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Integer>> multipartUploadByteBuffer(
        ServerRequest request,
    ...
    @Blocking
    public CompletableFuture<
        ServerResponse<Map<String, Integer>>
    > multipartFutureUploadByteBuffer(
        ServerRequest request,
        @FormParam("buffer") ByteBuffer buffer
    ) throws Exception {
        CompletableFuture<ServerResponse<Map<String, Integer>>> future =
            new CompletableFuture<>();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Object>> multipartUploadMixed(
        ServerRequest request,
        @FormParam("buffer") ByteBuffer buffer,
        @FormParam("user") User user,
    ...
    @Blocking
    public CompletableFuture<
        ServerResponse<Map<String, Object>>
    > multipartUploadFutureMixed(
        ServerRequest request,
        @FormParam("buffer") ByteBuffer buffer,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ) throws Exception {
        CompletableFuture<ServerResponse<Map<String, Object>>> future =
            new CompletableFuture<>();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<JsonNode> multipartUploadJson(
        ServerRequest request,
        @FormParam("json") JsonNode node
    ) throws Exception {
    ...
    @Blocking
    public CompletableFuture<
        ServerResponse<JsonNode>
    > multipartUploadFutureJson(
        ServerRequest request,
        @FormParam("json") JsonNode json
    ) throws Exception {
        CompletableFuture<ServerResponse<JsonNode>> future =
            new CompletableFuture<>();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Object>> multipartUploadMixedWithPath(
        ServerRequest request,
        @FormParam("path") java.nio.file.Path path,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ) throws Exception {
        return response(
    ...
    public CompletableFuture<
        ServerResponse<Map<String, Object>>
    > multipartUploadFutureMixedWithPath(
        ServerRequest request,
        @FormParam("path") java.nio.file.Path path,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Object>> multipartUploadMixedWithFile(
        ServerRequest request,
        ...
        return response(
            Map.of("file", file.length(), "user", user, "userId", userId)
        )
            .applicationJson()
            .ok();
    }
    ...
    public CompletableFuture<
        ServerResponse<Map<String, Object>>
    > multipartUploadFutureMixedWithFile(
        ServerRequest request,
        @FormParam("file") java.io.File file,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Object>> multipartUploadMultipleBuffers(
        ServerRequest request,
        @FormParam("file1") ByteBuffer file1,
        @FormParam("file2") ByteBuffer file2,
        @FormParam("file3") ByteBuffer file3,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ) throws Exception {
        return response(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, Object>> multipartUploadMultipleFiles(
        ServerRequest request,
        @FormParam("file1") File file1,
        @FormParam("file2") File file2,
        @FormParam("file3") File file3,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ) throws Exception {
        return response(
    ...
    public ServerResponse<Map<String, Object>> multipartUploadMultipleFiles(
        ServerRequest request,
        @FormParam("file1") java.nio.file.Path file1,
        @FormParam("file2") java.nio.file.Path file2,
        @FormParam("file3") java.nio.file.Path file3,
        @FormParam("user") User user,
        @FormParam("userId") Integer userId
    ) throws Exception {
        return response(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Blocking
    public ServerResponse<Map<String, String>> lastModifiedResponse(
        ServerRequest request
    ) {
