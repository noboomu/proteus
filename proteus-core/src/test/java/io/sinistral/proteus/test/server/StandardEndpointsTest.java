...
public class StandardEndpointsTest extends AbstractEndpointTest {
    ...
    public void testDebugBlockingEndpoint() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/debug/blocking")
            .then()
            .statusCode(200);
    }
    ...
    public void exchangeUserJson() {
        User user = given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/exchange/user/json")
            .as(User.class);
    ...
    public void genericSet() {
        given()
            .accept(ContentType.JSON)
            .when()
            .queryParam("ids", idSet)
            .get("v1/tests/generic/set")
            .then()
            .statusCode(200)
    ...
    public void genericBeanSet() {
        ...
        try {
            ...
            given()
                ...
                .accept(ContentType.JSON)
                .body(body)
                .post("v1/tests/generic/set/bean")
                .then()
                .statusCode(200)
                .body(containsString(firstNumber.toString()));
        } catch (Exception e) {
            fail(e.getMessage());
        }
    }
    ...
    public void genericBean() {
        ...
        try {
            ...
            given()
                ...
                .accept(ContentType.JSON)
                .body(body)
                .post("v1/tests/generic/bean")
                .then()
                .statusCode(200)
                .body(containsString(genericBean.getValue().toString()));
        } catch (Exception e) {
            fail(e.getMessage());
        }
    }
    ...
    public void genericBeanList() {
        ...
        try {
            ...
            given()
                ...
                .accept(ContentType.JSON)
                .body(body)
                .post("v1/tests/generic/list/bean")
                .then()
                .statusCode(200)
                .body(containsString(firstNumber.toString()));
        } catch (Exception e) {
    ...
    public void genericBeanMap() {
        ...
        try {
            ...
            given()
                ...
                .accept(ContentType.JSON)
                .body(body)
                .post("v1/tests/generic/map/bean")
                .then()
                .statusCode(200)
                .body(containsString(firstNumber.toString()));
        } catch (Exception e) {
    ...
    public void exchangeUserXml() {
        User user = given()
            ...
            .when()
            .get("v1/tests/exchange/user/xml")
            .as(User.class);
        assertThat(user.getId(), CoreMatchers.is(123L));
    }
    ...
    public void responseUserJson() {
        User user = given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/user/json")
            .as(User.class);
        assertThat(user.getId(), CoreMatchers.is(123L));
    }
    ...
    public void responseWorkerFuture() {
        Map response = given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/future/worker")
            .as(Map.class);
    ...
    public void responseWorkerFutureBlocking() {
        Map response = given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/future/worker/blocking")
            .as(Map.class);
        assertThat(response.get("status").toString(), CoreMatchers.is("OK"));
    }
    ...
    public void responseUserXml() {
        User user = given()
            .accept(ContentType.XML)
            .when()
            .get("v1/tests/response/user/xml")
            .as(User.class);
        assertThat(user.getId(), CoreMatchers.is(123L));
    }
    ...
    public void badRequest() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/response/badrequest")
            .then()
            .statusCode(400);
    }
    ...
    public void badRequestBlocking() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/response/badrequest/blocking")
            .then()
            .statusCode(400);
    }
    ...
    public void badRequestFuture() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/future/badrequest")
            .then()
            .statusCode(400);
    }
    ...
    public void notFoundFuture() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/future/notfound/blocking")
            .then()
            .statusCode(404);
    }
    ...
    public void badRequestFutureBlocking() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/future/badrequest/blocking")
            .then()
            .statusCode(400);
    }
    ...
    public void exchangePlaintext() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/exchange/plaintext")
            .then()
            .statusCode(200)
            .and()
    ...
    public void exchangePlaintext2() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/exchange/plaintext2")
            .then()
            .statusCode(200)
            .and()
            .body(containsString("Hello, World!"));
    ...
    public void responsePlaintext() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/response/plaintext")
            .then()
            .statusCode(200)
            .and()
            .body(containsString("Hello, World!"));
    ...
    public void responseEchoModel() {
        ...
        given()
            .contentType(ContentType.JSON)
            .accept(ContentType.JSON)
            .multiPart("user", model)
            .contentType(MediaType.MULTIPART_FORM_DATA.contentType())
            .when()
            .post("v1/tests/response/json/echo")
            .then()
            .statusCode(200)
            .and()
            .body(containsString("101"));
    }
    ...
    public void responseBeanParam() {
        ...
        given()
            ...
            .body(model)
            .when()
            .post("v1/tests/response/json/beanparam")
            .then()
            .statusCode(200)
            .and()
            .body(containsString("101"));
    ...
    public void responseOptionalBeanParam() {
        ...
        given()
            ...
            .body(model)
            .when()
            .post("v1/tests/response/json/beanparam-optional")
            .then()
            .statusCode(200)
            .and()
            .body(containsString("101"));
    ...
    public void responseFutureUser() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/future/user")
            .then()
            .statusCode(200)
            .and()
    ...
    public void responseFutureMap() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/future/map")
            .then()
            .statusCode(200)
            .and()
            .body("message", is("success"));
    ...
    public void responseFutureResponseMap() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/future/response")
            .then()
            .statusCode(200)
            .and()
            .body("message", is("success"));
    ...
    public void testRedirect() {
        given()
            ...
            .redirects()
            .follow(false)
            .get("v1/tests/redirect")
            .then()
            .statusCode(302)
            .and()
            .header("Server", "proteus")
            .and()
            .header("Location", "v1/response/debug/blocking");
    }
    ...
    public void testRedirectMovedPermanentlyCode() {
        given()
            ...
            .redirects()
            .follow(false)
            .get("v1/tests/redirect/permanent")
            .then()
            .statusCode(301)
            .and()
            .header("Location", "v1/response/debug/blocking");
    ...
    public void pathParam() {
        given()
            .accept(ContentType.TEXT)
            .when()
            .get("v1/tests/response/params/path/foobar")
            .then()
            .statusCode(200)
            .and()
    ...
    public void responseParseListParameter() {
        try {
            ...
            given()
                ...
                .body(values)
                .when()
                .post("v1/tests/response/parse/ids")
                .then()
                .statusCode(200);
        } catch (Exception e) {
    ...
    public void responseParseInstant() {
        ...
        given()
            ...
            .statusCode(200)
            .and()
            .body(containsString(instant.toString()));
    }
    ...
    public void responseParseTimestamp() {
        ...
        given()
            ...
            .statusCode(200)
            .and()
            .body(containsString(ts.toString()));
    }
    ...
    public void responseParseBigDecimal() {
        ...
        given()
            ...
            .statusCode(200)
            .and()
            .body(containsString(value.toString()));
    }
    ...
    public void notFound() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/error/404")
            .then()
            .statusCode(404)
            .body(containsString("No entity found"));
    }
    ...
    public void unauthorized() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/response/error/401")
            .then()
            .statusCode(401)
    ...
    public void maxValueError() {
        given()
            .queryParam("param", 105)
            .when()
            .get("v1/tests/response/max")
            .then()
            .statusCode(400)
            .log();
    }
    ...
    public void lastModified() {
        given()
            .accept(ContentType.JSON)
            .when()
            .get("v1/tests/headers/last-modified")
            .then()
            .statusCode(200)
            .body(containsString("value"))
            .header("last-modified", CoreMatchers.anything());
    }
    ...
    public void responseComplexParameters() {
        ...
        assertThat(
            (map.get("queryUUID").toString()),
            CoreMatchers.is(randomUUID.toString())
        );

        assertThat(
            (map.get("optionalQueryUUID").toString()),
            CoreMatchers.is(randomUUID.toString())
        );
        ...
        assertThat(
            (map.get("optionalQueryLong").toString()),
            CoreMatchers.is(longValue.toString())
        );

        assertThat(
            (map.get("optionalQueryEnum").toString()),
            CoreMatchers.is(UserType.ADMIN.name())
        );

        assertThat(
            (map.get("queryEnum").toString()),
            CoreMatchers.is(UserType.ADMIN.name())
        );

        assertThat(
            (map.get("headerString").toString()),
            CoreMatchers.is(stringValue)
        );

        assertThat(
            (map.get("optionalHeaderString").toString()),
            CoreMatchers.is(stringValue)
        );

        assertThat(
            (map.get("optionalQueryString").toString()),
            CoreMatchers.is(stringValue)
        );

        assertThat(
            (map.get("optionalQueryDate").toString()),
            containsString("1970-01-01")
        );
    }
}
