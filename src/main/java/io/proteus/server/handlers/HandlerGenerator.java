...
public class HandlerGenerator
{
	...
	public enum TypeHandler
	{
		...
		OptionalStringType("$T<String> $L = $T.string(exchange,$S)", false,  Optional.class,  StatementParameterType.LITERAL,io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
		OptionalLongType("$T<Long> $L = $T.longValue(exchange,$S)", false,   Optional.class, StatementParameterType.LITERAL, io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
		OptionalIntegerType("$T<Integer> $L = $T.integerValue(exchange,$S)", false,  Optional.class,  StatementParameterType.LITERAL, io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
		OptionalBooleanType("$T<Boolean> $L = $T.booleanValue(exchange,$S)", false,  Optional.class,  StatementParameterType.LITERAL,io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
		...
		OptionalFloatType("$T<Long> $L = $T.floatValue(exchange,$S)", false,   Optional.class, StatementParameterType.LITERAL, io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
		OptionalDoubleType("$T<Integer> $L = $T.doubleValue(exchange,$S)", false,  Optional.class,  StatementParameterType.LITERAL, io.proteus.server.Extractors.Optional.class, StatementParameterType.STRING),
	...
	//
	// Set<Class<?>> classes = getApiClasses("io.proteus.controllers",null);
	//
		...
		for (Method m : clazz.getDeclaredMethods())
		{
 			...
 			if (!m.getReturnType().toString().equals("void"))
			{
				...
				{ 
						...
						methodBuilder.addCode("$L.thenAccept( r ->  r.send(this,$L) )\n\t.exceptionally( ex -> ","response","exchange"); 
